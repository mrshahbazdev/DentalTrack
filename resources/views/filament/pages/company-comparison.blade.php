            ...
            @foreach ($companies as $company)
                <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden">
                    <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                        ...
                        <p class="text-blue-100 text-sm">{{ $company['technicians'] }} technicians · {{ $company['workstations'] }} workstations</p>
                    </div>
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="text-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                ...
                                <div class="text-xs text-gray-500">Orders/Day</div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-400">On-Time Delivery</span>
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Avg Step Duration</span>
