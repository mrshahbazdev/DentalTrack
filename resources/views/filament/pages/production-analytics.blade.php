    ...
    <div class="space-y-6" wire:poll.15s>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4 text-center">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Overdue</div>
            </div>
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4 text-center">
                <div class="text-2xl font-bold text-purple-600">{{ $stats['on_time_pct'] }}%</div>
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">On-Time Rate</div>
            </div>
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-4 text-center">
                <div class="text-2xl font-bold text-indigo-600">{{ $stats['completion_rate'] }}%</div>
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Completion Rate</div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Bottleneck Analysis (Slowest Stations)</h3>
                </div>
                    ...
                    <table class="w-full text-sm">
                        <thead class="text-xs text-gray-500 dark:text-gray-400 uppercase">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-center">Avg Min</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                    <td class="px-4 py-2">
                                        <div class="flex items-center gap-2">
                                            @if ($i === 0)
                                                <span class="text-red-500 text-xs font-bold">SLOWEST</span>
                                            @endif
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 py-6 text-center text-gray-400">No data for selected period.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Product Type Breakdown</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead class="text-xs text-gray-500 dark:text-gray-400 uppercase">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-center">Avg Hours</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-4 py-6 text-center text-gray-400">No data for selected period.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 p-6">
            ...
            @else
                <div class="text-center text-gray-400 py-8">No completed orders in the selected period.</div>
            @endif
        </div>
    </div>
</x-filament-panels::page>
